...
(function($,jquery, document) {
	var domBuffer = '<div class="mui-dtpicker" data-type="datetime">\
		<div class="mui-dtpicker-header">\
			<button data-id="btn-cancel" class="mui-btn select-cancel-bt">取消</button>\
			<button class="mui-btn" style="position:absolute;width:50px;margin-left:-25px;left:50%;color:#333;font-size:15px;">生日</button>\
