...
!function (root, factory) {
    ...
    var CONTAINER_TPL = [
        '<div style="background:#000;position:fixed;width:100%;height:100%;z-index:10;left:0px;top:0px;">',
            ...
            '<div style="position:absolute;width:100%;height:100%;top:0;left:0;" id="touch-holder">',
                '<div style="border:1px solid rgba(255, 255, 255, 0.5);outline: 200px solid rgba(0, 0, 0, 0.6);width: 300px;height: 300px;position: relative;margin-left: 50%;left: -110px;margin-top: {{margin-top}};" id="clip-box">',
                '</div>',
    ...
    p._init = function (src, opts) {
        ...
        this.maxTop = (wHeight - 300) / 2;
        this.maxLeft = (wWidth - 300) / 2;
        this.timer = null;
    ...
    p._fixPos = function () {
        ...
        // fix right-border
        if (this.left + this.width < this.maxLeft + 331) {
            this.left = this.maxLeft + 331 - this.width;
            hasFix = true;
        }
        return hasFix;
    };
